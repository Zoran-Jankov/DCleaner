...
$formFileSorter.controls.AddRange(@($lblDownloads,$txtDownloads,$lblDocuments,$txtDocuments,$lblPictures,
$txtPictures,$lblVideos,$txtVideos,$btnSortFiles,$lblProgramInstallers,$txtProgramInstallers,
...
$customFoldersName = "Custom-Folders.cvs"
